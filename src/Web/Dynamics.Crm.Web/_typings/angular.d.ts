...
declare module ng {
    ...
    interface IAngularStatic {
         ...
         */
        bootstrap(element: any, modules?: any, config?: IAngularBootstrapConfig): IInjectorService;
    ...
    interface IFilterFilter {
        <T>(array: T[], expression: any, comparator?: any): T[];
    }
    ...
    interface IFilterOrderBy {
         ...
         */
        <T>(array: T[], expression, reverse?: boolean): T[];
    }
    ...
    interface IFilterProvider extends IServiceProvider {
         ...
         */
        register(name): IServiceProvider;
    }
    ...
    interface ILocationService {
         ...
         */
        search(search: string, paramValue): ILocationService;
    ...
    interface IQService {
        ...
        resolve<T>(value: IPromise<T>): IPromise<T>;
        /**
         * Wraps an object that might be a value or a (3rd party) then-able promise into a $q promise. This is useful when you are dealing with an object that might or might not be a promise, or if the promise comes from a source that can't be trusted.
         */
    ...
    */
    interface IHttpProviderDefaults {
         ...
         */
        transformResponse?: IHttpResponseTransformer;
    ...
    interface IHttpInterceptor {
        ...
        response?: <T>(response: IHttpPromiseCallbackArg<T>) => T;
    ...
    interface IHttpProvider extends IServiceProvider {
         ...
         * each request.
         */
        interceptors: IHttpInterceptorFactory;
         ...
         */
        useLegacyPromiseExtensions(value: boolean): IHttpProvider;
    }
